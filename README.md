...
- **2.6.x** — Based on [OpenVPN 2.6.x](https://github.com/OpenVPN/openvpn/releases/tag/v2.6.20) (well-tested, production use)
...
```bash
make build                           # Default: OpenVPN 2.6.20
